...
def upgrade() -> None:
    """Upgrade schema."""
    # pgvector ships with the pgvector/pgvector image but is not enabled in a
    # new database automatically. Without this, revision 09d9469046c4 fails on
    # `Vector(384)` with "type vector does not exist" and a fresh clone can
    # never finish `alembic upgrade head`.
